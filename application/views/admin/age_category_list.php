                                ...
                                style="border-radius:3px !important;margin-top:10px !important;" 
                                        class="btn btn-warning" 
                                            data-target="#demo-lg-modal" data-toggle="modal" 
                                                onClick="modal_form('age_category_add','1')">
                            <i class="entypo-user-add"></i> Create Age Category</button>
				</div>
                    ...
                    <tbody>
						...
						?>
							<tr>
								...
								<td><?php echo $row['start_age'];?></td>
								<td><?php echo $row['end_age'];?></td>
								<td>
									<a data-target="#demo-lg-modal" data-toggle="modal" 
                                                        onClick="modal_form('age_category_profile',<?php echo $row['age_category_id']; ?>)">
										<button class="btn btn-info btn-xs btn-labeled fa fa-location-arrow">Profile</button>
									</a>
									<a data-target="#demo-lg-modal" data-toggle="modal" 
                                                            onClick="modal_form('age_category_edit',<?php echo $row['age_category_id']; ?>)">
										<button class="btn btn-success btn-xs btn-labeled fa fa-wrench">Edit</button>
									</a>
									<a href="<?php echo base_url();?>index.php/admin/age_category/delete/<?php echo $row['age_category_id']; ?>">
