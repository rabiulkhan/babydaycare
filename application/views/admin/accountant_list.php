    ...
    <div class="col-lg-12">
        <div class="panel">
            ...
            <div class="panel-body">
            	<div class="col-lg-12">
				<a  href="<?php echo base_url();?>index.php/admin/accountant_add">
					<button class="btn btn-dark btn-labeled fa fa-plus-circle pull-right">Create Accountant</button>
                </a>
				</div>
                <table id="demo-table" class="table-striped" data-toolbar="#demo-custom-toolbar" data-sort-name="id" data-sort-order="desc" data-pagination="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1">
                    ...
                    <tbody>
						...
						?>
							<tr>
								<td><img src="<?php echo base_url(); ?>uploads/accountant_image/accountant_<?php echo $row['accountant_id']; ?>.jpg" class="img-sm img-circle" width="130" /></td>
								<td><?php echo $row['name'];?></td>
								<td><?php echo $row['email'];?></td>
								<td><?php echo $row['appointment_date'];?></td>
								<td>
									<a href="<?php echo base_url();?>index.php/admin/accountant/profile/<?php echo $row['accountant_id']; ?>">
										<button class="btn btn-info btn-xs btn-labeled fa fa-location-arrow">Profile</button>
									</a>
									<a href="<?php echo base_url();?>index.php/admin/accountant_edit/edit_view/<?php echo $row['accountant_id']; ?>">
