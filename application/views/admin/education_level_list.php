                                ...
                                style="border-radius:3px !important;margin-top:10px !important;" 
                                        class="btn btn-warning" 
                                            data-target="#demo-lg-modal" data-toggle="modal" 
                                                onClick="modal_form('education_level_add','1')">
                            <i class="entypo-user-add"></i> Create Education Level</button>
				</div>
							...
							<tr>
								...
								<td>
									<a data-target="#demo-lg-modal" data-toggle="modal" 
                                                        onClick="modal_form('education_level_profile',<?php echo $row['education_level_id']; ?>)">
										<button class="btn btn-info btn-xs btn-labeled fa fa-location-arrow">Profile</button>
									</a>
									<a data-target="#demo-lg-modal" data-toggle="modal" 
                                                            onClick="modal_form('education_level_edit',<?php echo $row['education_level_id']; ?>)">
										<button class="btn btn-success btn-xs btn-labeled fa fa-wrench">Edit</button>
									</a>
									<a href="<?php echo base_url();?>index.php/admin/education_level/delete/<?php echo $row['education_level_id']; ?>">
