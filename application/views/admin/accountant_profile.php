...
<div id="content-container" style="padding-top:50px !important;">
	...
	<hr style="margin-top: 10px !important;">
		<div class="text-center pad-all">
			<div class="pad-ver">
				<img src="<?php echo base_url(); ?>uploads/accountant_image/accountant_<?php echo $row['accountant_id'];?>.jpg"  class="img-md img-border img-circle" alt="Profile Picture">
			</div>
    ...
    <div class="col-sm-12">
        <div class="panel-body">
            ...
            <table class="table table-striped" style="border-radius:3px;">
				...
				<tr>
                    <th class="custom_td">Gender</th>
                    <td class="custom_td"><?php echo $row['gender']?></td>
                </tr>
                <tr>
