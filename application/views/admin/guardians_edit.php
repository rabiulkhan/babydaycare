            ...
            <div class="col-lg-12">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <center><h3 class="panel-title">Edit Guardians</h3></center>
                    </div>
					<?php 
                    ...
                    ?>
                    <!--Form for Accountant-->
                    <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin/guardians/do_update/<?php echo $row['guardians_id'] ?>" method="post" id="demo-bv-bsc-tabs" target="_top"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <span class="pull-left btn btn-default btn-file">
										Choose your photo <input type="file" name="image" value="<?php echo base_url(); ?>uploads/guardians_image/guardians_<?php echo $row['guardians_id']; ?>.jpg">
									</span>
                                </div>
                            </div>   
							<hr>
                            ...
                            <div class="panel-footer" style="">
								<div class="row">
									<div class="col-sm-9 col-sm-offset-3">
										...
										type="submit">Edit Guardians</button>
									</div>
								</div>
							</div>
