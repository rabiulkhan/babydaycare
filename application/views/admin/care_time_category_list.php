                                ...
                                style="border-radius:3px !important;margin-top:10px !important;" 
                                        class="btn btn-warning" 
                                            data-target="#demo-lg-modal" data-toggle="modal" 
                                                onClick="modal_form('care_time_category_add','1')">
                            <i class="entypo-user-add"></i> Create Care Time Category</button>
				</div>
							...
							<tr>
								...
								<td>
									<a data-target="#demo-lg-modal" data-toggle="modal" 
                                                        onClick="modal_form('care_time_category_profile',<?php echo $row['care_time_category_id']; ?>)">
										<button class="btn btn-info btn-xs btn-labeled fa fa-location-arrow">Profile</button>
									</a>
									<a data-target="#demo-lg-modal" data-toggle="modal" 
                                                            onClick="modal_form('care_time_category_edit',<?php echo $row['care_time_category_id']; ?>)">
										<button class="btn btn-success btn-xs btn-labeled fa fa-wrench">Edit</button>
									</a>
									<a href="<?php echo base_url();?>index.php/admin/care_time_category/delete/<?php echo $row['care_time_category_id']; ?>">
